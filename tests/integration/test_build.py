...
class TestTeacherSetBuilder:
    ...
    def test_build_legacy_sets_enhanced_missing_identifier(
        ...
        assert field_strings == [
            ...
            "=520  \\\\$3Playaway (missing identifier).",
            "=521  2\\$a6-8",
            "=526  8\\$aLanguage Arts",
            "=690  \\7$aBook Club.$2bookops",
...
class TestLiveTeacherSetBuilder:
    ...
    def test_build_legacy_sets_large_print(
        ...
        assert field_strings == [
            ...
            "=520  \\\\$3Roll of thunder, hear my cry$aA black family living in Mississippi during the Depression of the 1930s is faced with prejudice and discrimination which its children do not understand.",
            "=521  2\\$a6-8",
            "=526  8\\$aLanguage Arts",
            "=690  \\7$aBook Club.$2bookops",
            ...
            "=700  12$aTaylor, Mildred D.$tRoll of thunder, hear my cry$f2018$x9781432849252",
            "=901  \\\\$amlnyc-bot$bCATBL",
