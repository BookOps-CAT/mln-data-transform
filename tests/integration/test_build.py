...
class TestLiveTeacherSetBuilder:
    ...
    def test_genre_adventure(self, caplog, live_creds, mock_control_number_file):
        ...
        assert sorted(field_strings) == sorted(
            [
                ...
                # "=600  10$aHoudini, Harry,$d1874-1926$vJuvenile fiction.",
                # "=600  11$aHoudini, Harry,$d1874-1926$vFiction.",
                # "=600  00$aJack$c(Fictitious character from Osborne)$vJuvenile fiction.",
                # "=600  00$aAnnie$c(Fictitious character from Osborne)$vJuvenile fiction.",
                # "=600  00$aPelé,$d1940-2022$vJuvenile fiction.",
                # "=600  01$aPelé,$d1940-$vFiction.",
                # "=650  \\0$aTime travel$vJuvenile fiction.",
                # "=650  \\0$aMagicians$vJuvenile fiction.",
                # "=650  \\0$aMagic$vJuvenile fiction.",
                # "=650  \\0$aTree houses$vJuvenile fiction.",
                # "=650  \\1$aTime travel$vFiction.",
                # "=650  \\1$aMagicians$vFiction.",
                # "=650  \\1$aMagic$vFiction.",
                # "=650  \\1$aTree houses$vFiction.",
                # "=650  \\0$aMagic tricks$vJuvenile literature.",
                # "=650  \\1$aMagic tricks.",
                # "=650  \\0$aSpace and time$vJuvenile fiction.",
                # "=650  \\0$aGiant panda$vJuvenile fiction.",
                # "=650  \\0$aPandas$vJuvenile fiction.",
                # "=650  \\0$aSiblings$vJuvenile fiction.",
                # "=650  \\0$aPenguins$vJuvenile fiction.",
                # "=650  \\1$aSpace and time$vFiction.",
                # "=650  \\1$aGiant panda$vFiction.",
                # "=650  \\1$aPandas$vFiction.",
                # "=650  \\1$aSiblings$vFiction.",
                # "=650  \\0$aGiant panda$vJuvenile literature.",
                # "=650  \\0$aEndangered species$vJuvenile literature.",
                # "=650  \\1$aGiant panda.",
                # "=650  \\1$aEndangered species.",
                # "=650  \\1$aSoccer$vFiction.",
                # "=650  \\0$aSoccer$vJuvenile literature.",
                # "=650  \\1$aSoccer.",
                # "=651  \\0$aNew York (N.Y.)$xHistory$y20th century$vJuvenile fiction.",
                # "=651  \\1$aNew York (N.Y.)$xHistory$y20th century$vFiction.",
                # "=651  \\0$aChina$vJuvenile fiction.",
                # "=651  \\1$aChina$vFiction.",
                # "=651  \\0$aMexico$xHistory$y1946-1970$vJuvenile fiction.",
                # "=651  \\1$aMexico$xHistory$y1946-1970$vFiction.",
                # "=655  \\0$aTime travel (Fiction)",
                # "=655  \\1$aTime travel (Fiction).",
                # "=655  \\7$aTime-travel fiction.$2lcgft",
                # "=655  \\7$aFantasy fiction.$2lcgft",
                # "=655  \\7$aLiterature.$2lcgft",
                # "=655  \\0$aAdventure stories.",
                # "=655  \\1$aFantasy fiction.",
                # "=655  \\1$aHistorical fiction.",
                # "=655  \\7$aHistorical fiction.$2lcgft",
                # "=655  \\7$aAction and adventure fiction.$2lcgft",
                # "=655  \\0$aSoccer stories.",
    ...
    def test_genre_award_winners(self, caplog, live_creds, mock_control_number_file):
        ...
        assert sorted(field_strings) == sorted(
            [
                ...
                "=521  2\\$aK-2",
                "=526  8\\$aLanguage Arts",
                # "=600  10$aCopeland, Misty$vJuvenile fiction.",
                # "=600  11$aCopeland, Misty$vFiction.",
                # "=600  10$aGandhi,$cMahatma,$d1869-1948$vJuvenile literature.",
                # "=600  10$aGandhi, Arun$vJuvenile literature.",
                # "=600  11$aGandhi,$cMahatma,$d1869-1948.",
                # "=600  11$aGandhi, Arun.",
                # "=650  \\0$aFirst day of school$vJuvenile fiction.",
                # "=650  \\0$aElementary schools$vJuvenile fiction.",
                # "=650  \\0$aValkyries (Norse mythology)$vJuvenile fiction.",
                # "=650  \\0$aMythology, Norse$vJuvenile fiction.",
                # "=650  \\0$aIndividuality in children$vJuvenile fiction.",
                # "=650  \\1$aFirst day of school$vFiction",
                # "=650  \\1$aSchools$vFiction",
                # "=650  \\1$aValkyries (Norse mythology)$vFiction",
                # "=650  \\1$aMythology, Norse$vFiction",
                # "=650  \\1$aIndividuality$vFiction",
                # "=650  \\0$aBallerinas$vJuvenile fiction.",
                # "=650  \\0$aAfrican American women entertainers$vJuvenile fiction.",
                # "=650  \\0$aBallet dancing$vJuvenile fiction.",
                # "=650  \\0$aSelf-confidence$vJuvenile fiction.",
                # "=650  \\0$aDance$vJuvenile fiction.",
                # "=650  \\0$aAfrican Americans$vJuvenile fiction.",
                # "=650  \\1$aBallet dancing$vFiction.",
                # "=650  \\1$aSelf-confidence$vFiction.",
                # "=650  \\1$aDance$vFiction.",
                # "=650  \\1$aAfrican Americans$vFiction.",
                # "=650  \\0$aPacifists$zIndia$vBiography$vJuvenile literature.",
                # "=650  \\0$aStatesmen$zIndia$vBiography$vJuvenile literature.",
                # "=650  \\1$aPacifists$zIndia.",
                # "=650  \\1$aStatesmen$zIndia.",
                # "=650  \\0$aViolin$vJuvenile fiction.",
                # "=650  \\0$aTalent shows$vJuvenile fiction.",
                # "=650  \\0$aGrandfathers$vJuvenile fiction.",
                # "=650  \\0$aStage fright$vJuvenile fiction.",
                # "=650  \\0$aJapanese Americans$vJuvenile fiction.",
                # "=650  \\0$aChild musicians$vJuvenile fiction.",
                # "=650  \\1$aViolin$vFiction.",
                # "=650  \\1$aTalent shows$vFiction.",
                # "=650  \\1$aGrandfathers$vFiction.",
                # "=650  \\1$aStage fright$vFiction.",
                # "=650  \\0$aCity and town life$vJuvenile fiction.",
                # "=650  \\0$aSize$vJuvenile fiction.",
                # "=650  \\0$aElephants$vJuvenile fiction.",
                # "=650  \\0$aMice$vJuvenile fiction.",
                # "=650  \\0$aFriendship$vJuvenile fiction.",
                # "=650  \\1$aCity and town life$vEasy picture.",
                # "=650  \\1$aSize$vEasy picture.",
                # "=650  \\1$aElephants$vEasy picture.",
                # "=650  \\1$aMice$vEasy picture.",
                # "=650  \\1$aFriendship$vEasy picture.",
                # "=650  \\0$aMood (Psychology)$vJuvenile fiction.",
                # "=650  \\0$aRain and rainfall$vJuvenile fiction.",
                # "=650  \\0$aNeighbors$vJuvenile fiction.",
                # "=650  \\1$aMood (Psychology)$vFiction.",
                # "=650  \\1$aRain and rainfall$vFiction.",
                # "=650  \\1$aNeighbors$vFiction.",
                # "=650  \\0$aBird trapping$vJuvenile fiction.",
                # "=650  \\1$aBird trapping$vFiction.",
                # "=650  \\0$aSquashes$vJuvenile fiction.",
                # "=650  \\1$aSquashes$vFiction.",
                # "=650  \\1$aFriendship$vFiction.",
                # "=650  \\0$aMultiracial children$vJuvenile fiction.",
                ...
                # "=650  \\0$aTea$vJuvenile fiction.",
                # "=650  \\0$aParties$vJuvenile fiction.",
                # "=650  \\1$aEtiquette$vFiction.",
                # "=650  \\1$aBears$vFiction.",
                # "=650  \\1$aAnimals$xInfancy$vFiction.",
                # "=650  \\1$aTea$vFiction.",
                # "=650  \\1$aParties$vFiction.",
                # "=651  \\0$aJapan$vJuvenile fiction.",
                # "=651  \\1$aJapan$vFiction.",
                # "=653  \\0$aFamily literacy collection.",
                # "=655  \\0$aPicture books for children",
                # "=655  \\1$aPicture books.",
                # "=655  \\7$aPicture books.$2lcgft",
                # "=655  \\7$aTalking books.$2lcgft",
                # "=655  \\7$aSound books.$2lcgft",
                # "=655  \\7$aChildren's audiobooks.$2lcgft",
    ...
    def test_genre_manga(self, caplog, live_creds, mock_control_number_file):
        ...
        assert sorted(field_strings) == sorted(
            [
                ...
                "=521  2\\$a9-12",
                "=526  8\\$aLanguage Arts",
                # "=600  10$aLuffy, Monkey D.$c(Fictitious character)$vComic books, strips, etc.",
                # "=650  \\0$aArtists$vComic books, strips, etc.",
                # "=650  \\0$aCinematography$xSpecial effects$vComic books, strips, etc.",
                # "=650  \\0$aCollege students$vComic books, strips, etc.",
                # "=650  \\0$aComic books, strips, etc.$zJapan$vTranslations into English.",
                # "=650  \\0$aDating (Social customs)$vComic books, strips, etc.",
                # "=650  \\0$aDemonology$vComic books, strips, etc.",
                # "=650  \\0$aDevil$vComic books, strips, etc.",
                # "=650  \\0$aGhosts$vComic books, strips, etc.$vYoung adult fiction.",
                # "=650  \\0$aGood and evil$vComic books, strips, etc.$vYoung adult fiction.",
                # "=650  \\0$aGraphic novels$zJapan$vTranslations into English.",
                # "=650  \\0$aHigh school students$vComic books, strips, etc.",
                # "=650  \\0$aHigh school students$vComic books, strips, etc.$vYoung adult fiction.",
                # "=650  \\0$aHigh schools$vComic books, strips, etc.",
                # "=650  \\0$aInterpersonal relations$vComic books, strips, etc.",
                # "=650  \\0$aMan-woman relationships$vComic books, strips, etc.",
                # "=650  \\0$aMonsters$vComic books, strips, etc.",
                # "=650  \\0$aMotion pictures$xProduction and direction$vComic books, strips, etc.",
                # "=650  \\0$aNinja$zJapan$vComic books, strips, etc.",
                # "=650  \\0$aPirates$vComic books, strips, etc.",
                # "=650  \\0$aPrincesses$vComic books, strips, etc.",
                # "=650  \\0$aPsychics$vComic books, strips, etc.$vYoung adult fiction.",
                # "=650  \\0$aQuests (Expeditions)$vComic books, strips, etc.",
                # "=650  \\0$aSpirits$vComic books, strips, etc.$vYoung adult fiction.",
                # "=650  \\0$aSupernatural$vComic books, strips, etc.",
                # "=650  \\0$aTeenagers$vComic books, strips, etc.",
                # "=650  \\0$aVampires$vComic books, strips, etc.",
                # "=650  \\0$aVolleyball$vComic books, strips, etc.",
                # "=650  \\0$aYoung artists$vComic books, strips, etc.",
                # "=650  \\0$aYōkai (Japanese folklore)$vComic books, strips, etc.",
                # "=650  \\1$aAdventure comic books, strips, etc.",
                # "=650  \\1$aCartoons and comics.",
                # "=650  \\1$aCinematography$xSpecial effects$vFiction.",
                # "=650  \\1$aCollege students$vFiction.",
                # "=650  \\1$aHigh school students$vCartoons and comics.",
                # "=650  \\1$aMan-woman relationships$vCartoons and comics.",
                # "=650  \\1$aManga graphic novels.",
                # "=650  \\1$aMotion pictures$xProduction and direction$vFiction.",
                # "=650  \\1$aNinja$vFiction.",
                # "=650  \\1$aPirates$vFiction.",
                # "=650  \\1$aSchool sports$vFiction.",
                # "=650  \\1$aSupernatural$vFiction.",
                # "=650  \\1$aTeenage boys$vFiction.",
                # "=650  \\1$aVolleyball players$vFiction.",
                # "=650  \\1$aVolleyball$vFiction.",
                # "=650  \\1$aYoung artists$vFiction.",
                # "=651  \\1$aJapan$vFiction.",
                ...
                # "=655  \\7$aAction and adventure comics.$2lcgft",
                ...
                # "=655  \\7$aParanormal romance fiction.$2lcgft",
                # "=655  \\7$aRomance comics.$2lcgft",
                # "=655  \\7$aSchool comics.$2lcgft",
                # "=655  \\7$aShōjo manga.$2lcgft",
                # "=655  \\7$aShōnen manga.$2lcgft",
                "=690  \\7$aTopic$2bookops",
    ...
    def test_genre_mystery(self, caplog, live_creds, mock_control_number_file):
        ...
        assert sorted(field_strings) == sorted(
            [
                ...
                "=521  2\\$a9-12",
                "=526  8\\$aLanguage Arts",
                # "=650  \\0$aHousehold employees$vJuvenile fiction.",
                # "=650  \\0$aOrphans$vJuvenile fiction.",
                # "=650  \\0$aSex role$vJuvenile fiction.",
                ...
                # "=651  \\0$aGreat Britain$xHistory$yVictoria, 1837-1901$vJuvenile fiction.",
                # "=651  \\0$aLondon (England)$xHistory$y19th century$vJuvenile fiction.",
    ...
    def test_genre_poetry(self, caplog, live_creds, mock_control_number_file):
        ...
        assert sorted(field_strings) == sorted(
            [
                ...
                "=521  2\\$a6-8",
                "=526  8\\$aLanguage Arts",
                # "=600  10$aNelson, Marilyn,$d1946-$vJuvenile poetry.",
                # "=600  11$aNelson, Marilyn,$d1946-$vPoetry.",
                # "=650  \\0$aAfrican American train attendants$vJuvenile poetry.",
                # "=650  \\0$aAfrican Americans$vJuvenile poetry.",
                # "=650  \\0$aAfrican Americans$xCivil rights$vJuvenile poetry.",
                # "=650  \\0$aAfrican Americans$xCivil rights$xHistory$y20th century$vJuvenile poetry.",
                # "=650  \\0$aAuthorship$vJuvenile poetry.",
                # "=650  \\0$aCivil rights movements$zUnited States$xHistory$y20th century$vJuvenile poetry.",
                # "=650  \\0$aCivil rights workers$vJuvenile poetry.",
                # "=650  \\0$aCivil rights$vJuvenile literature.",
                # "=650  \\0$aCivil rights$vJuvenile poetry.",
                # "=650  \\0$aEquality$vJuvenile poetry.",
                # "=650  \\0$aPoetry$xAuthorship.",
                # "=650  \\1$aAfrican Americans$vPoetry.",
                # "=650  \\1$aAmerican poetry.",
                # "=650  \\1$aAuthors, American$vPoetry.",
                # "=650  \\1$aAuthorship$vPoetry.",
                # "=650  \\1$aAutobiographical poetry.",
                # "=650  \\1$aCivil rights$vPoetry.",
                # "=651  \\0$aUnited States$xIntellectual life$y20th century$xHistory$vJuvenile poetry.",
                # "=655  \\0$aChildren's poetry, American.",
                # "=655  \\0$aPicture books for children.",
                # "=655  \\7$aAutobiographical poetry.$2lcgft",
                # "=655  \\7$aChildren's Poetry, American.$2lcgft",
                # "=655  \\7$aHistorical poetry.$2lcgft",
                # "=655  \\7$aPicture books.$2lcgft",
                "=690  \\7$aTopic$2bookops",
                "=691  \\7$aAfrican Americans$2bookops",
    ...
    def test_genre_coming_of_age(self, caplog, live_creds, mock_control_number_file):
        ...
        assert sorted(field_strings) == sorted(
            [
                ...
                "=521  2\\$a9-12",
                "=526  8\\$aLanguage Arts",
                # "=650  \\0$aAdolescence$vComic books, strips, etc.",
                # "=650  \\0$aChild development.",
                # "=650  \\0$aChildren.",
                # "=650  \\0$aComing of age$vComic books, strips, etc.",
                # "=650  \\0$aFriendship$vComic books, strips, etc.",
                # "=650  \\0$aInterpersonal relations$vComic books, strips, etc.",
                # "=650  \\0$aLove in adolescence$vComic books, strips, etc.",
                # "=650  \\0$aMedicine$vComic books, strips, etc.",
                # "=650  \\0$aPreteen girls$vComic books, strips, etc.",
                # "=650  \\0$aSummer$vComic books, strips, etc.",
                # "=650  \\0$aTeenage girls$vComic books, strips, etc.",
                # "=650  \\0$aTeenagers$xConduct of life$vComic books, strips, etc.",
                # "=650  \\0$aVacations$vComic books, strips, etc.",
                # "=650  \\1$aCartoons and comics.",
                # "=655  \\0$aGraphic novels.",
                # "=655  \\7$aComics (Graphic works)$2lcgft",
                # "=655  \\7$aComing-of-age comics.$2lcgft",
                # "=655  \\7$aFiction.$2lcgft",
                # "=655  \\7$aGraphic novels.$2lcgft",
                "=690  \\7$aBook Club$2bookops",
                "=695  \\7$aComics & Graphic Novels$2bookops",
    ...
    def test_topic_ancient_civ(self, caplog, live_creds, mock_control_number_file):
        ...
        assert sorted(field_strings) == sorted(
            [
                ...
                # "=651  \\1$aGreece$xCivilization$yTo 146 B.C.",
                # "=651  \\1$aGreece$xHistory$yTo 146 B.C.",
                # "=651  \\1$aGreece$xSocial life and customs.",
                # "=651  \\1$aIndia$xCivilization$yTo 1200.",
                # "=651  \\1$aMexico$xCivilization.",
                # "=650  \\1$aAztecs$xHistory.",
                # "=650  \\1$aAztecs$xSocial life and customs.",
                # "=650  \\1$aAztecs.",
                # "=650  \\1$aIndians of Mexico.",
    ...
    def test_topic_astronomy(self, caplog, live_creds, mock_control_number_file):
        ...
        assert sorted(field_strings) == sorted(
            [
                ...
                "=521  2\\$aK-2",
                "=526  8\\$aScience",
                # "=650  \\0$aGalaxies$vJuvenile literature.",
                # "=650  \\1$aGalaxies.",
                # "=655  \\7$aLiterature.$2lcgft",
                "=690  \\7$aBook Club$2bookops",
    ...
    def test_topic_behavior(self, caplog, live_creds, mock_control_number_file):
        ...
        assert sorted(field_strings) == sorted(
            [
                ...
                "=521  2\\$aK-2",
                "=526  8\\$aSocial Studies",
                # "=600  10$aHo, Tuan,$d1975-$vJuvenile literature.",
                # "=600  10$aJennings, Jazz$vJuvenile literature.",
                # "=600  10$aKing, Martin Luther,$cJr.,$d1929-1968$vJuvenile fiction.",
                # "=600  10$aLester, Julius,$d1939-2018$vJuvenile literature.",
                # "=600  10$aYeboah, Emmanuel Ofosu,$d1977-$vJuvenile literature.",
                # "=600  11$aHo, Tuan,$d1975-",
                # "=600  11$aJennings, Jazz",
                # "=600  11$aKing, Martin Luther,$cJr.,$d1929-1968$vFiction.",
                # "=600  11$aLester, Julius,$d1939-2018.",
                # "=600  11$aYeboah, Emmanuel Ofosu,$d1977-",
                # "=611  20$aMarch on Washington for Jobs and Freedom$d(1963 :$cWashington, D.C.)$vJuvenile fiction.",
                # "=611  21$aMarch on Washington for Jobs and Freedom$d(1963 :$cWashington, D.C.)$vFiction.",
                # "=650  \\0$aAnimals$vJuvenile fiction.",
                # "=650  \\0$aAutistic children$vJuvenile fiction.",
                # "=650  \\0$aBlind$xBooks and reading.",
                # "=650  \\0$aBlue$vJuvenile fiction.",
                # "=650  \\0$aBoard books.",
                # "=650  \\0$aBoat people$zVietnam$vBiography$vJuvenile literature.",
                # "=650  \\0$aBraille books.",
                # "=650  \\0$aBullying in schools$vJuvenile fiction.",
                # "=650  \\0$aChildren$xSocial life and customs$vJuvenile literature.",
                # "=650  \\0$aColor$vJuvenile fiction.",
                # "=650  \\0$aColors$vJuvenile literature.",
                # "=650  \\0$aCommunities$vJuvenile literature.",
                # "=650  \\0$aCommunity and school$vJuvenile literature.",
                # "=650  \\0$aCommunity leadership$vJuvenile literature.",
                # "=650  \\0$aCommunity life$vJuvenile literature.",
                # "=650  \\0$aCounting$vJuvenile fiction.",
                # "=650  \\0$aCrayons$vJuvenile fiction.",
                # "=650  \\0$aCyclists$zGhana$vBiography$vJuvenile literature.",
                # "=650  \\0$aElephants$vJuvenile fiction.",
                # "=650  \\0$aEmigration and immigration$vJuvenile fiction.",
                # "=650  \\0$aEmpathy in children$vJuvenile literature.",
                # "=650  \\0$aEmpathy$vJuvenile literature.",
                # "=650  \\0$aEnvironmental sciences$vJuvenile literature.",
                # "=650  \\0$aFamilies$vJuvenile fiction.",
                # "=650  \\0$aFamilies$vJuvenile literature.",
                # "=650  \\0$aFamilies.",
                # "=650  \\0$aFathers and daughters$vJuvenile fiction.",
                # "=650  \\0$aFriendship$vJuvenile fiction.",
                # "=650  \\0$aGardening$vJuvenile fiction.",
                # "=650  \\0$aGender identity$vJuvenile literature.",
                # "=650  \\0$aGender nonconformity$vJuvenile literature.",
                # "=650  \\0$aGenerosity$vJuvenile fiction.",
                # "=650  \\0$aGhanaians$vBiography$vJuvenile literature.",
                # "=650  \\0$aGirls$vJuvenile fiction.",
                # "=650  \\0$aGrandmothers$vJuvenile fiction.",
                # "=650  \\0$aHelping behavior$vJuvenile literature.",
                # "=650  \\0$aHouseholds$vJuvenile literature.",
                # "=650  \\0$aIdentity (Psychology)$vJuvenile fiction.",
                # "=650  \\0$aIllegal immigration$vJuvenile fiction.",
                # "=650  \\0$aImmigrants$vJuvenile fiction.",
                # "=650  \\0$aImmigrants$zUnited States$vJuvenile literature.",
                # "=650  \\0$aImmigrants$zUnited States$vPictorial works$vJuvenile literature.",
                # "=650  \\0$aIndividuality$vJuvenile fiction.",
                # "=650  \\0$aKindness$vJuvenile fiction.",
                # "=650  \\0$aNature$vJuvenile literature.",
                # "=650  \\0$aNoncitizens$vJuvenile fiction.",
                # "=650  \\0$aNoncitizens.",
                # "=650  \\0$aNuclear families.",
                # "=650  \\0$aOccupations$vJuvenile literature.",
                # "=650  \\0$aPeople with disabilities$zGhana$vBiography$vJuvenile literature.",
                # "=650  \\0$aPlay$vJuvenile fiction.",
                # "=650  \\0$aPolitical refugees$zCanada$vBiography$vJuvenile literature.",
                # "=650  \\0$aPolitical refugees$zVietnam$vBiography$vJuvenile literature.",
                # "=650  \\0$aPoverty$vJuvenile fiction.",
                # "=650  \\0$aPrejudices$zUnited States$vJuvenile literature.",
                # "=650  \\0$aPreschool children.",
                # "=650  \\0$aRabbits$vJuvenile fiction.",
                # "=650  \\0$aRace awareness$zUnited States$vJuvenile literature.",
                # "=650  \\0$aRacism$zUnited States$vJuvenile literature.",
                # "=650  \\0$aRecycling industry$vJuvenile literature.",
                # "=650  \\0$aRed$vJuvenile fiction.",
                # "=650  \\0$aRefugee children$zCanada$vJuvenile literature.",
                # "=650  \\0$aRefugee children$zVietnam$vJuvenile literature.",
                # "=650  \\0$aSchools$vJuvenile fiction.",
                # "=650  \\0$aSelf-esteem$vJuvenile fiction.",
                # "=650  \\0$aSelf-perception$vJuvenile literature.",
                # "=650  \\0$aService learning$vJuvenile literature.",
                # "=650  \\0$aShoes$vJuvenile fiction.",
                # "=650  \\0$aSiblings$vJuvenile fiction.",
                # "=650  \\0$aSnakes$vJuvenile fiction.",
                # "=650  \\0$aSocial action$vJuvenile literature.",
                # "=650  \\0$aSocial classes$vJuvenile fiction.",
                # "=650  \\0$aStudents$vJuvenile fiction.",
                # "=650  \\0$aSwine$vJuvenile fiction.",
                # "=650  \\0$aTeachers$vJuvenile fiction.",
                # "=650  \\0$aTeams in the workplace$vJuvenile literature.",
                # "=650  \\0$aThought and thinking.",
                # "=650  \\0$aTouch$vJuvenile literature.",
                # "=650  \\0$aTrans children$vJuvenile literature.",
                # "=650  \\0$aTrans people$vBiography$vJuvenile literature.",
                # "=650  \\0$aTrans people$xIdentity$vJuvenile literature.",
                # "=650  \\0$aTrans women$vBiography$vJuvenile literature.",
                # "=650  \\0$aTrans youth$vJuvenile literature.",
                # "=650  \\0$aTransgender girls$vBiography$vJuvenile literature.",
                # "=650  \\0$aTwins$vJuvenile fiction.",
                # "=650  \\0$aVoluntarism$vJuvenile literature.",
                # "=650  \\0$aWings (Anatomy)$vJuvenile fiction.",
                # "=650  \\0$aYoung volunteers in community development$vJuvenile literature.",
                # "=650  \\1$aAfrican Americans$vFiction.",
                # "=650  \\1$aAnimals$vFiction.",
                # "=650  \\1$aAutism$vFiction.",
                # "=650  \\1$aBabies$vFiction.",
                # "=650  \\1$aBoat people$zVietnam$vBiography",
                # "=650  \\1$aChildren$xSocial life and customs.",
                # "=650  \\1$aColor$vFiction",
                # "=650  \\1$aColor.",
                # "=650  \\1$aCommunities.",
                # "=650  \\1$aCommunity leadership.",
                # "=650  \\1$aCommunity life.",
                # "=650  \\1$aCounting$vFiction",
                # "=650  \\1$aCrayons$vFiction",
                # "=650  \\1$aCyclists$zGhana",
                # "=650  \\1$aElephants$vFiction.",
                # "=650  \\1$aEmigration and immigration$vFiction",
                # "=650  \\1$aEmigration and immigration$vFiction.",
                # "=650  \\1$aEmpathy in children.",
                # "=650  \\1$aEmpathy.",
                # "=650  \\1$aFamilies",
                # "=650  \\1$aFamilies$vFiction.",
                # "=650  \\1$aFathers and daughters$vFiction",
                # "=650  \\1$aFeminism$vFiction.",
                # "=650  \\1$aFlight$vFiction.",
                # "=650  \\1$aFriendship$vFiction.",
                # "=650  \\1$aGardening$vFiction.",
                # "=650  \\1$aGenerosity$vFiction.",
                # "=650  \\1$aGrandmothers$vFiction.",
                # "=650  \\1$aHelping behavior.",
                # "=650  \\1$aIdentity$vFiction",
                # "=650  \\1$aIllegal immigration$vFiction",
                # "=650  \\1$aImmigrants$vFiction.",
                # "=650  \\1$aImmigrants$zUnited States$vPictorial works.",
                # "=650  \\1$aImmigrants$zUnited States.",
                # "=650  \\1$aIndividuality$vFiction.",
                # "=650  \\1$aKindness$vFiction.",
                # "=650  \\1$aNoncitizens$vFiction",
                # "=650  \\1$aOccupations.",
                # "=650  \\1$aPeople with disabilities$zGhana$vBiography",
                # "=650  \\1$aPigs$vFiction.",
                # "=650  \\1$aPlay$vFiction.",
                # "=650  \\1$aPolitical refugees$zCanada$vBiography",
                # "=650  \\1$aPolitical refugees$zVietnam$vBiography",
                # "=650  \\1$aPoverty$vFiction.",
                # "=650  \\1$aRace awareness.",
                # "=650  \\1$aRacism.",
                # "=650  \\1$aRecycling industry.",
                # "=650  \\1$aSchool buildings.",
                # "=650  \\1$aSchools$vFiction.",
                # "=650  \\1$aSelf-esteem$vFiction.",
                # "=650  \\1$aService learning.",
                # "=650  \\1$aSex role$vFiction.",
                # "=650  \\1$aShoes$vFiction.",
                # "=650  \\1$aSiblings$vFiction.",
                # "=650  \\1$aSnakes$vFiction.",
                # "=650  \\1$aSocial action.",
                # "=650  \\1$aStories in rhyme.",
                # "=650  \\1$aTeams in the workplace.",
                # "=650  \\1$aToleration.",
                # "=650  \\1$aTouch.",
                # "=650  \\1$aTransgender people",
                # "=650  \\1$aTwins$vFiction.",
                # "=650  \\1$aVietnamese Canadians$vBiography",
                # "=650  \\1$aVoluntarism.",
                # "=650  \\1$aWings$vFiction.",
                # "=650  \\1$aYoung volunteers in community development.",
                # "=651  \\0$aGhana$vBiography$vJuvenile literature.",
                # "=651  \\0$aUnited States$xEmigration and immigration$vJuvenile fiction.",
                # "=651  \\0$aUnited States$xEmigration and immigration$vJuvenile literature.",
                # "=651  \\0$aUnited States$xEmigration and immigration$vPictorial works$vJuvenile literature.",
                # "=651  \\0$aUnited States$xRace relations$vJuvenile literature.",
                # "=651  \\1$aGhana$vBiography",
                # "=651  \\1$aGuatemala.",
                # "=651  \\1$aUnited States$xEmigration and immigration$vFiction.",
                # "=651  \\1$aUnited States$xEmigration and immigration$vPictorial works.",
                # "=651  \\1$aUnited States$xEmigration and immigration.",
                # "=653  \\0$aFamily literacy collection.",
                # "=655  \\0$aChildren's literature.",
                # "=655  \\0$aChildren's writings, American.",
                # "=655  \\0$aElectronic books.",
                # "=655  \\0$aJuvenile literature.",
                # "=655  \\0$aLocal author.",
                # "=655  \\0$aPicture books for children",
                # "=655  \\0$aPicture books for children.",
                # "=655  \\0$aReaders (Primary)",
                # "=655  \\1$aBiographies.$0http://id.loc.gov/authorities/subjects/sh2009000869$0http://id.loc.gov/authorities/names/n79032186$0http://id.loc.gov/authorities/subjects/sh99001237",
                # "=655  \\1$aPicture books.",
                # "=655  \\7$aAutobiographies.$2lcgft",
                # "=655  \\7$aBiographies.$2lcgft",
                # "=655  \\7$aBoard books.$2lcgft",
                # "=655  \\7$aBraille books.$2lcgft",
                # "=655  \\7$aFiction.$2lcgft",
                # "=655  \\7$aHumorous fiction.$2lcgft",
                ...
                # "=655  \\7$aPicture books for children.$2lcgft",
                # "=655  \\7$aPicture books.$2lcgft",
    ...
    def test_topic_chinese_americans(
        ...
        assert sorted(field_strings) == sorted(
            [
                ...
                "=521  2\\$a9-12",
                "=526  8\\$aLanguage Arts",
                # "=600  10$aBui, Thi$vComic books, strips, etc.",
                # "=600  10$aDenson, Abby$xTravel$zJapan$zTokyo.",
                # "=600  10$aSun, Wukong$c(Fictitious character)$vJuvenile fiction.",
                # "=650  \\0$aAbandoned children$vJuvenile fiction.",
                # "=650  \\0$aAdventure stories.",
                # "=650  \\0$aAmericans$zTaiwan$vJuvenile fiction.",
                # "=650  \\0$aArtists$vJuvenile fiction.",
                # "=650  \\0$aAsian American teenagers$vJuvenile fiction.",
                # "=650  \\0$aBest friends$vFiction.",
                # "=650  \\0$aBoarding schools$vJuvenile fiction.",
                # "=650  \\0$aBooks and reading$vJuvenile fiction.",
                # "=650  \\0$aBounty hunters$vJuvenile fiction.",
                # "=650  \\0$aBrothers$vJuvenile fiction.",
                # "=650  \\0$aChinese Americans$vJuvenile fiction.",
                # "=650  \\0$aCollege students$vFiction.",
                # "=650  \\0$aComputer crimes$vJuvenile fiction.",
                # "=650  \\0$aComputer programming$vJuvenile literature.",
                # "=650  \\0$aDating (Social customs)$vJuvenile fiction.",
                # "=650  \\0$aDemonology$vJuvenile fiction.",
                # "=650  \\0$aDisguise$vJuvenile fiction.",
                # "=650  \\0$aDivorce$vJuvenile fiction.",
                # "=650  \\0$aDysfunctional families$vFiction.",
                # "=650  \\0$aEast Indian American women$vJuvenile fiction.",
                # "=650  \\0$aEast Indian Americans$vJuvenile fiction.",
                # "=650  \\0$aEthnicity$zKorea (South)$zSeoul$vJuvenile fiction.",
                # "=650  \\0$aExotic animals$vFiction.",
                # "=650  \\0$aFamilies$zCalifornia$vJuvenile fiction.",
                # "=650  \\0$aFamilies$zNew York (State)$zNew York$vJuvenile fiction.",
                # "=650  \\0$aFantasy.",
                # "=650  \\0$aFear$vFiction.",
                # "=650  \\0$aFriendship$vFiction.",
                # "=650  \\0$aGay teenagers$vJuvenile fiction.",
                # "=650  \\0$aGrandparents$vJuvenile fiction.",
                # "=650  \\0$aGrief$vJuvenile fiction.",
                # "=650  \\0$aHackers$vJuvenile fiction.",
                # "=650  \\0$aHigh school students$vFiction.",
                # "=650  \\0$aHigh school students$vJuvenile fiction.",
                # "=650  \\0$aHigh schools$vJuvenile fiction.",
                # "=650  \\0$aIdentity (Philosophical concept)$vJuvenile fiction.",
                # "=650  \\0$aIllegal immigration$vJuvenile fiction.",
                # "=650  \\0$aImmigrants$vJuvenile fiction.",
                # "=650  \\0$aJapanese language$vConversation and phrase books$xEnglish.",
                # "=650  \\0$aKidnapping$vJuvenile fiction.",
                # "=650  \\0$aLesbians$vFiction.",
                # "=650  \\0$aLetters$vJuvenile fiction.",
                # "=650  \\0$aMen's choirs$vJuvenile fiction.",
                # "=650  \\0$aMentally ill parents$vFiction.",
                # "=650  \\0$aMilitary weapons$vJuvenile fiction.",
                # "=650  \\0$aMothers and daughters$vJuvenile fiction.",
                # "=650  \\0$aMultiracial people$vFiction.",
                # "=650  \\0$aMultiracial people$vJuvenile fiction.",
                # "=650  \\0$aMurder$vFiction.",
                # "=650  \\0$aMuslims$vJuvenile fiction.",
                # "=650  \\0$aMuslims$zUnited States$vJuvenile fiction.",
                # "=650  \\0$aMythology, Chinese$vJuvenile fiction.",
                # "=650  \\0$aNightmares$vJuvenile fiction.",
                # "=650  \\0$aNoncitizens$vJuvenile fiction.",
                # "=650  \\0$aNoncitizens.",
                # "=650  \\0$aOrphans$vJuvenile fiction.",
                # "=650  \\0$aParanormal fiction.",
                # "=650  \\0$aPython (Computer program language)$vJuvenile literature.",
                # "=650  \\0$aRefugees$zUnited States$vBiography$vComic books, strips, etc.",
                # "=650  \\0$aSchools$vJuvenile fiction.",
                # "=650  \\0$aSex crimes$vJuvenile fiction.",
                # "=650  \\0$aSex role$vJuvenile fiction.",
                # "=650  \\0$aSpy stories.",
                # "=650  \\0$aSuicide$vJuvenile fiction.",
                # "=650  \\0$aTerrorism$vJuvenile fiction.",
                # "=650  \\0$aText messages (Cell phone systems)$vFiction.",
                # "=650  \\0$aTwins$vJuvenile fiction.",
                # "=650  \\0$aVideo games$vJuvenile fiction.",
                # "=650  \\0$aVideo games$xDesign$vJuvenile literature.",
                # "=650  \\0$aVietnam War, 1961-1975$vPersonal narratives, Vietnamese$vComic books, strips, etc.",
                # "=650  \\0$aVietnamese Americans$vBiography$vComic books, strips, etc.",
                # "=650  \\0$aWomen computer programmers$vJuvenile literature.",
                # "=650  \\0$aWomen heroes$vJuvenile fiction.",
                # "=650  \\0$aYoung adult fiction.",
                # "=650  \\0$aYoung adult literature.",
                # "=650  \\0$aZoos$zIndiana$vFiction.",
                # "=650  \\1$aAdventure and adventurers$vFiction.",
                # "=650  \\1$aAmericans$zTaiwan$vFiction",
                # "=650  \\1$aArtists$vFiction",
                # "=650  \\1$aArtists$vFiction.",
                # "=650  \\1$aBoarding schools$vFiction.",
                # "=650  \\1$aBooks and reading$vFiction.",
                # "=650  \\1$aBounty hunters$vFiction.",
                # "=650  \\1$aBrothers$vFiction.",
                # "=650  \\1$aChinese Americans$vFiction.",
                # "=650  \\1$aComputer crimes$vFiction.",
                # "=650  \\1$aDating (Social customs)$vFiction.",
                # "=650  \\1$aDemonology$vFiction.",
                # "=650  \\1$aDisguise$vFiction.",
                # "=650  \\1$aDivorce$vFiction",
                # "=650  \\1$aEast Indian Americans$vFiction.",
                # "=650  \\1$aFamily life$zCalifornia$vFiction.",
                # "=650  \\1$aFamily life$zCalifornia$zOakland$vFiction.",
                # "=650  \\1$aFamily life$zIllinois$zChicago$vFiction.",
                # "=650  \\1$aFamily life$zNew York (State)$zNew York$vFiction.",
                # "=650  \\1$aFamily problems$vFiction.",
                # "=650  \\1$aGrandparents$vFiction",
                # "=650  \\1$aGrief$vFiction",
                # "=650  \\1$aHackers$vFiction.",
                ...
                # "=650  \\1$aIllegal immigration$vFiction.",
                # "=650  \\1$aImmigrants$vFiction.",
                # "=650  \\1$aInternet games$vFiction.",
                # "=650  \\1$aKidnapping$vFiction.",
                # "=650  \\1$aLesbians$vFction.",
                # "=650  \\1$aLetters.",
                # "=650  \\1$aLove$vFiction.",
                # "=650  \\1$aMen's choirs$vFiction.",
                # "=650  \\1$aMothers and daughters$vFiction.",
                # "=650  \\1$aMuslims$vFiction",
                # "=650  \\1$aMuslims$vFiction.",
                # "=650  \\1$aMythology, Chinese$vFiction.",
                # "=650  \\1$aNightmares$vFiction.",
                # "=650  \\1$aNoncitizens$vFiction.",
                # "=650  \\1$aOrphans$vFiction.",
                # "=650  \\1$aProducers and directors$vFiction.",
                # "=650  \\1$aProgramming (Computers).",
                # "=650  \\1$aRacially mixed people$vFiction",
                # "=650  \\1$aRacially mixed people$vFiction.",
                # "=650  \\1$aRobots$vFiction.",
                # "=650  \\1$aSchools$vFiction.",
                # "=650  \\1$aScience fiction.",
                # "=650  \\1$aSecrets$vFiction",
                # "=650  \\1$aSelf-perception$vFiction.",
                # "=650  \\1$aSex role$vFiction.",
                # "=650  \\1$aSexual abuse$vFiction",
                # "=650  \\1$aSexual abuse$vFiction.",
                # "=650  \\1$aSocial classes$vFiction.",
                # "=650  \\1$aSoldiers$vFiction.",
                # "=650  \\1$aSpies$vFiction.",
                # "=650  \\1$aSuicide$vFiction",
                # "=650  \\1$aSupernatural$vFiction",
                # "=650  \\1$aTerrorism$vFiction.",
                # "=650  \\1$aTotalitarianism$vFiction.",
                # "=650  \\1$aTwins$vFiction.",
                # "=650  \\1$aWar$vFiction.",
                # "=651  \\0$aAustin (Tex.)$vFiction.",
                # "=651  \\0$aCalifornia$vJuvenile fiction.",
                # "=651  \\0$aChicago (Ill.)$vJuvenile fiction.",
                # "=651  \\0$aIndiana$vFiction.",
                # "=651  \\0$aMassachusetts$vFiction.",
                # "=651  \\0$aNew York (N.Y.)$vJuvenile fiction.",
                # "=651  \\0$aOakland (Calif.)$vJuvenile fiction.",
                # "=651  \\0$aTaiwan$vJuvenile fiction.",
                # "=651  \\0$aTokyo (Japan)$vDirectories.",
                # "=651  \\0$aTokyo (Japan)$xDescription and travel$vComic books, strips, etc.",
                # "=651  \\0$aTokyo (Japan)$xSocial life and customs$vComic books, strips, etc.",
                # "=651  \\1$aCalifornia$vFiction.",
                # "=651  \\1$aChicago (Ill.)$vFiction.",
                # "=651  \\1$aKorea$vFiction.",
                # "=651  \\1$aNew York (N.Y.)$vFiction.",
                # "=651  \\1$aOakland (Calif.)$vFiction.",
                # "=651  \\1$aTaiwan$vFiction",
                # "=651  \\1$aTokyo (Japan)$vGuides.",
                # "=651  \\1$aTokyo (Japan)$xSocial life and customs.",
                # "=655  \\0$aElectronic books.",
                # "=655  \\0$aGraphic novels.",
                # "=655  \\0$aGuidebooks.",
                # "=655  \\1$aLove stories.",
                # "=655  \\1$aRomance fiction.",
                # "=655  \\7$aAutobiographical comics.$2lcgft",
                # "=655  \\7$aBildungsromans.$2lcgft",
                # "=655  \\7$aBiographies.$2lcgft",
                # "=655  \\7$aCity directories.$2lcgft",
                # "=655  \\7$aComics (Graphic works)$2lcgft",
                ...
                "=700  12$aRedgate, Riley$tNote worthy$f2017$x9781419723735",
                ...
                "=949  \\\\$h10$i[BARCODE]-Note worthy$leduls$mm$p0.00$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    ...
    def test_topic_new_york_city(self, caplog, live_creds, mock_control_number_file):
        ...
        assert sorted(field_strings) == sorted(
            [
                ...
                # "=651  \\1$aNew York (N.Y.)$vPictorial works.",
                # "=651  \\1$aNew York (N.Y.)$xDescription and travel.",
