...
class TestTeacherSetBuilderLogging:
    ...
    def test_build_legacy_sets_incomplete(
        self, mock_session_managers_missing_data, caplog, mock_location_mapping
    ):
        legacy_set = self.BUILDER.build_legacy_set(bib_id="12345678")
        self.BUILDER.build_set_copies(set_data=legacy_set)
    ...
    def test_genre_adventure(self, live_creds, mock_control_number_file):
        ...
        assert sorted(field_strings) == sorted(
            [
                ...
                "=949  \\\\$h10$i[BARCODE]-Pandas and other endangered species$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
                "=949  \\\\$h10$i[BARCODE]-High Time for Heroes #51$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
                "=949  \\\\$h10$i[BARCODE]-High Time for Heroes #51$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
