...
class TestLiveTeacherSetBuilder:
    ...
    def test_build_legacy_sets_enhanced(
        ...
        assert field_strings == [
            ...
            "=300  \\\\$a11 item(s)",
            '=500  \\\\$aSet consists of 10 copies of "Roll of thunder, hear my cry", 1 large print copy of "Roll of thunder, hear my cry".',
            ...
            "=520  \\\\$3Logan family$aA black family living in Mississippi during the Depression of the 1930s is faced with prejudice and discrimination which its children do not understand.",
            "=521  2\\$a6-8",
            ...
            "=910  \\\\$aBL",
            "=949  \\\\$a*b2=8;b3=e;bn=ed;",
            "=949  \\\\$h10$i[BARCODE]-Roll of thunder, hear my cry$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
            "=949  \\\\$h10$i[BARCODE]-Roll of thunder, hear my cry$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
            "=949  \\\\$h10$i[BARCODE]-Roll of thunder, hear my cry$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
            "=949  \\\\$h10$i[BARCODE]-Roll of thunder, hear my cry$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
            "=949  \\\\$h10$i[BARCODE]-Roll of thunder, hear my cry$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    ...
    #             "=910  \\\\$aBL",
    #             "=949  \\\\$a*b2=8;b3=e;bn=ed;",
    #             "=949  \\\\$h10$i[BARCODE]-Hurry up, Houdini!$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Hurry up, Houdini!$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Magic tricks from the tree house$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Magic tricks from the tree house$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-A perfect time for pandas$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-A perfect time for pandas$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Pandas and other endangered species$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Pandas and other endangered species$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-High time for heroes$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-High time for heroes$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Soccer on Sunday$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Soccer on Sunday$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Soccer$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Soccer$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #         ]
    #     )
    ...
    #             "=910  \\\\$aBL",
    #             "=949  \\\\$a*b2=8;b3=e;bn=ed;",
    #             "=949  \\\\$h10$i[BARCODE]-Edda$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Firebird$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Grandfather Gandhi$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Hana Hashimoto, sixth violin$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Little Elliot, big city$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Rain!$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Shh! We have a plan$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Sophie's squash$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Take me out to the Yakyu$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Tea party rules$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #         ]
    #     )
    ...
    #             "=910  \\\\$aBL",
    #             "=949  \\\\$a*b2=8;b3=e;bn=ed;",
    #             "=949  \\\\$h10$i[BARCODE]-Behind the scenes!!$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Behind the scenes!!$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Behind the scenes!!$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Bleach$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Bleach$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Bleach$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Devil's line$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Devil's line$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Devil's line$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Haikyu!!$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Haikyu!!$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Haikyu!!$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Horimiya$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Horimiya$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Horimiya$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Monthly girls' Nozaki-kun$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Monthly girls' Nozaki-kun$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Monthly girls' Nozaki-kun$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Naruto$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Naruto$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Naruto$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-One piece$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-One piece$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-One piece$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Shigeru Mizuki's Kitaro$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Shigeru Mizuki's Kitaro$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Shigeru Mizuki's Kitaro$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Yona of the dawn$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Yona of the dawn$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Yona of the dawn$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #         ]
    #     )
    ...
    #             "=910  \\\\$aBL",
    #             "=949  \\\\$a*b2=8;b3=e;bn=ed;",
    #             "=949  \\\\$h10$i[BARCODE]-A spy in the house$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-A spy in the house$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-A spy in the house$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-A spy in the house$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-A spy in the house$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    ...
    #             "=910  \\\\$aBL",
    #             "=949  \\\\$a*b2=8;b3=e;bn=ed;",
    #             "=949  \\\\$h10$i[BARCODE]-How I discovered poetry$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-How I discovered poetry$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-How I discovered poetry$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-How I discovered poetry$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-How I discovered poetry$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-I, too, am America$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-I, too, am America$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-I, too, am America$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-I, too, am America$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-I, too, am America$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-When thunder comes$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-When thunder comes$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-When thunder comes$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-When thunder comes$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-When thunder comes$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    ...
    #             "=910  \\\\$aBL",
    #             "=949  \\\\$a*b2=8;b3=e;bn=ed;",
    #             "=949  \\\\$h10$i[BARCODE]-This one summer$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-This one summer$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-This one summer$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-This one summer$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-This one summer$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    ...
    #             "=910  \\\\$aBL",
    #             "=949  \\\\$a*b2=8;b3=e;bn=ed;",
    #             "=949  \\\\$h10$i[BARCODE]-Ancient Rome$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Ancient Mesopotamia$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Ancient Maya$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Ancient India$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Ancient Greece$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Ancient Egypt$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Ancient China$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Ancient Aztecs$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #         ]
    #     )
    #     assert len(caplog.records) == 2
    #     assert [i.msg for i in caplog.records] == [
    ...
    #             "=910  \\\\$aBL",
    #             "=949  \\\\$a*b2=8;b3=e;bn=ed;",
    #             "=949  \\\\$h10$i[BARCODE]-Galaxies, galaxies!$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Galaxies, galaxies!$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Galaxies, galaxies!$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Galaxies, galaxies!$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Galaxies, galaxies!$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    ...
    #             "=910  \\\\$aBL",
    #             "=949  \\\\$a*b2=8;b3=e;bn=ed;",
    #             "=949  \\\\$h10$i[BARCODE]-Adrift at sea$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Be the change in your community$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Can I play, too?$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Can we help?$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Each kindness$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Emmanuel's dream$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Empathy$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Families around the world$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Families$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Families, families, families!$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Feminist Baby$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-I am Jazz$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-If you plant a seed$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-It's okay to be "
    #             "different$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Let's talk about "
    #             "race$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Look where we live!$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-My brother Charlie$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-My family, your family$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Red$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-The black book of colors$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-The great big green book$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-The soda bottle school$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Their great gift$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Those shoes$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Two white rabbits$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-We came to America$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-We march$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Whose hands are these?$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Wings$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #         ]
    #     )
    ...
    #             "=910  \\\\$aBL",
    #             "=949  \\\\$a*b2=8;b3=e;bn=ed;",
    #             "=949  \\\\$h10$i[BARCODE]-A line in the dark$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-All that I can fix$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Cool Tokyo guide$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Down and Across$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Emergency contact$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-From Twinkle, with love$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Girl code$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Love, hate & other filters$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Noteworthy$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Picture us in the light$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Rebel Seoul$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Saints and misfits$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Starfish$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-The astonishing color of after$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-The best we could do$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-The epic crush of Genie Lo$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-The speaker$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-Warcross$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-You bring the distant near$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #         ]
    #     )
    ...
    #             "=910  \\\\$aBL",
    #             "=949  \\\\$a*b2=8;b3=e;bn=ed;",
    #             "=949  \\\\$h10$i[BARCODE]-This is New York$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-This is New York$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-This is New York$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-This is New York$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #             "=949  \\\\$h10$i[BARCODE]-This is New York$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
