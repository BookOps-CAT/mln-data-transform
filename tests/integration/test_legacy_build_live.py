...
class TestLiveLegacyTeacherSetBuilder:
    BUILDER = LegacyTeacherSetBuilder(file="tests/data/all_legacy_sets.txt")
    ...
    #     valid_set_copies = self.BUILDER.build_set_copies(
    #         set_data=legacy_set, control_number="nn-mlnyc-0000001", log_id=legacy_set["bib_id"]
    #     )
    #     bibs = [i.to_bib() for i in valid_set_copies]
    #     field_strings = [str(i) for i in bibs[0].fields]
    #     assert len(valid_set_copies[0].components) == 2
    ...
    #     valid_set_copies = self.BUILDER.build_set_copies(
    #         set_data=legacy_set, control_number="nn-mlnyc-0000001"
    #     )
    ...
    #             '=520  \\\\$3Green kids club$aBe a part of the The Green Kids Club, where you\'ll learn how to conserve our natural resources and protect our endangered species! In this program, the animals of the world realize that they need the help of humans to protect their homes. They choose Victor and Maya to be the ""Green Kids"" and teach others the importance of protecting and conserving our environment. Young viewers will be inspired to do their part to preserve the planet and its important wildlife.',
    #             "=521  2\\$aK-2",
    #             "=526  8\\$aSocial Studies",
    #             "=690  \\7$aTopic.$2bookops",
    #             "=691  \\7$aAfrican Americans.$2bookops",
    ...
    #             "=700  12$aHoffman, Mary,$d1945-$tThe great big green book.$f2015.$x9781847804457",
    ...
    #             "=730  02$aGreen kids club.$f2015.$x741421151192",
    #             "=901  \\\\$amlnyc-bot$bCATBL",
    ...
    #             "=949  \\\\$h10$i[BARCODE]-Green kids club [DVD]$nGreen kids club [DVD]$leduls$om$q30010$t252$u-$vLOGDOE/mlnyc-bot",
    #         ]
    #     )
