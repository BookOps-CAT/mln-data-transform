from mln_data_transform.components import LegacyTeacherSetData
...
class TestTeacherSetBib:
    def test_teacher_set_from_json(self, platform_test_data):
        legacy_bib = LegacyTeacherSetData(
            ...
            title=platform_test_data["title"],
        ...
        assert legacy_bib.field_008 == "120508nuuuuuuuu       j      000 1 eng dnam a "
    ...
    def test_teacher_set_from_json_None(self, platform_test_data):
        ...
        assert legacy_bib.field_008 is None
